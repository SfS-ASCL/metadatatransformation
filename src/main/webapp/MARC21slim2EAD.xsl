...
aid}?></eadid>
                ...
                <filedesc>
                        ...
                        <author encodinganalog="Creator">Finding aid prepared by an XSLT stylesheet taken from MarcEdit, and adapted to fit SfS needs. +++ This is a preliminary version +++</author>

                        </titlestmt>
                        <publicationstmt>
                        <publisher encodinganalog="Publisher">University of Tuebingen</publisher>

                        <address>
                            <addressline>Wilhelmstrasse 19, 72074 Tuebingen, Germany</addressline>
                        </address>
                        ...
                        <note encodinganalog="Description">
                            <p>Funding for encoding this finding aid was provided through a grant
                                    awarded by the German Research Foundation, funding references DO 1346/4-2, WA 3085/1-2 and HI 495/4-2.</p>
                        </note>
                        </notestmt>
                </filedesc>
                ...
                <profiledesc>
                        <creation encodinganalog="Description">Finding aid encoded with the help of MarcEdit (xslt stylesheet), adapted by Claus Zinn, NaLiDa Project, Sfs Tuebingen.
    ...
    <xsl:template match="marc:record">
        <archdesc level="collection" type="inventory" relatedencoding="MARC21">
            ...
            <repository encodinganalog="852">
              <corpname encodinganalog="852$a">University of Tuebingen<subarea encodinganalog="852$b">Archives</subarea></corpname>

              <address>
                   <addressline>Seminar fuer Sprachwissenschaft</addressline>
                   <addressline>University of Tuebingen</addressline>
                   <addressline>72074 Tuebingen</addressline>
                   <addressline>Phone: +49 (7071) xxx-yyy </addressline>
                   <addressline>http://nalida.sfs.uni-tuebingen.de/</addressline>
